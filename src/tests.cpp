...
TEST_CASE( "RapidjsonRedactor Search For Member By Name", "[ppm][redaction][rapidjsonredactor][searchformemberbyname]") {
...
TEST_CASE( "RapidjsonRedactor Search For Member By Path", "[ppm][redaction][rapidjsonredactor][searchformemberbypath]") {
    RapidjsonRedactor rapidjsonRedactor;
...
TEST_CASE( "RapidjsonRedactor Redact Member By Path", "[ppm][redaction][rapidjsonredactor][redactbypath]" ) {
    ...
    std::string memberPaths[] = { 
                            "payload.data.partII.value.accelLong",
                            "payload.data.partII.value.accelLat",
                            "payload.data.partII.value.accelVert",
                            "payload.data.partII.value.yawRate",
                            "payload.data.partII.value.steeringWheelAngle",
                            "payload.data.partII.value.leftTurnSignalOn",
                            "payload.data.partII.value.rightTurnSignalOn",
                            "payload.data.partII.value.hazardSignalOn",
                            "payload.data.partII.value.fogLightOn",
                            "payload.data.partII.value.lowBeamHeadlightsOn",
                            "payload.data.partII.value.highBeamHeadlightsOn",
                            "payload.data.partII.value.automaticLightControlOn",
                            "payload.data.partII.value.daytimeRunningLightsOn",
                            "payload.data.partII.value.parkingLightsOn",
                            "payload.data.partII.value.wiperStatusFront",
                            "payload.data.partII.value.wiperStatusRear",
                            "payload.data.partII.value.wiperRateFront",
                            "payload.data.partII.value.wiperRateRear",
                            "payload.data.partII.value.eventAirBagDeployment",
                            "payload.data.partII.value.sunSensor",
                            "payload.data.partII.value.coefficientOfFriction",
                            "payload.data.partII.value.ambientAirTemperature",
                            "payload.data.partII.value.ambientAirPressure",
                            "payload.data.partII.value.transmissionState",
                            "payload.data.partII.value.vehicleSpeed",
                            "payload.data.partII.value.antiLockBrakeStatus",
                            "payload.data.partII.value.stabilityControlStatus",
                            "payload.data.partII.value.tractionControlStatus",
                            "payload.data.partII.value.brakeBoostApplied",
                            "payload.data.partII.value.brakeAppliedStatus",
                            "payload.data.partII.value.auxiliaryBrakeStatus",
                            "payload.data.partII.value.tirePressure",
                            "payload.data.partII.value.acceleratorPedalPosition",
                            "payload.data.partII.value.brakePedalPosition",
                            "payload.data.partII.value.disabledVehicle",
                            "payload.data.partII.value.stalledVehicle",
                            "payload.data.partII.value.airBagDeployment",
                        };
